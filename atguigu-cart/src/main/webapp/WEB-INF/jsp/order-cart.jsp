...
<form id="orderForm" class="hide" action="http://localhost:8086/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="刘德华"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="昌平区 xxxxxxxxx"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">尚硅谷</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">北京 昌平区 五环外六环里</div>
						<div class="adr-m" limit="30">昌平区 xxxxxxxxx</div>
